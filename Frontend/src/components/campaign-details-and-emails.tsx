      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="bg-gradient-to-r from-green-400 to-green-600 text-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-lg mb-2">
            <strong>Company:</strong> TechGadgets Inc.
          </p>
          <p className="text-lg mb-4">
            <strong>Company Description:</strong> TechGadgets Inc. is a leading
            innovator in smart home technology, dedicated to making everyday
            life more convenient and efficient through cutting-edge devices.
          </p>
          <p className="text-lg mb-2">
            <strong>Product:</strong> Smart Home Devices
          </p>
          <p className="text-lg">
            <strong>Target Audience:</strong> Tech-savvy homeowners, age 25-45
          </p>
        </section>
